...
"[project]/UAS_SOSIALMEDIA/client-new/node_modules/next/dist/compiled/react-server-dom-turbopack/cjs/react-server-dom-turbopack-client.browser.development.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"production" !== ("TURBOPACK compile-time value", "development") && function() {
    ...
    function fulfillReference(response, reference, value, fulfilledChunk) {
        for(var handler = reference.handler, parentObject = reference.parentObject, key = reference.key, map = reference.map, path = reference.path, i = 1; i < path.length; i++){
            for(; "object" === (typeof value === "undefined" ? "undefined" : _type_of._(value)) && null !== value && value.$$typeof === REACT_LAZY_TYPE;)if (value = value._payload, value === handler.chunk) value = handler.value;
            else {
                switch(value.status){
                    case "resolved_model":
        ...
        for(; "object" === (typeof value === "undefined" ? "undefined" : _type_of._(value)) && null !== value && value.$$typeof === REACT_LAZY_TYPE;)if (path = value._payload, path === handler.chunk) value = handler.value;
        else {
            switch(path.status){
                case "resolved_model":
        ...
        if (parentObject[0] === REACT_ELEMENT_TYPE && "object" === _type_of._(handler.value) && null !== handler.value && handler.value.$$typeof === REACT_ELEMENT_TYPE) switch(reference = handler.value, key){
            case "3":
    ...
    function startAsyncIterable(response, id, iterator, streamState) {
        ...
        resolveStream(response, id, iterator ? iterable[ASYNC_ITERATOR]() : iterable, {
            ...
            error: function error(_error) {
                closed = !0;
                for(nextWriteIndex === buffer.length && (buffer[nextWriteIndex] = createPendingChunk(response)); nextWriteIndex < buffer.length;)triggerErrorOnChunk(response, buffer[nextWriteIndex++], _error);
            }
        }, streamState);
    }
    ...
    var React = __turbopack_context__.r("[project]/UAS_SOSIALMEDIA/client-new/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)"), ReactDOM = __turbopack_context__.r("[project]/UAS_SOSIALMEDIA/client-new/node_modules/next/dist/compiled/react-dom/index.js [app-client] (ecmascript)"), decoderOptions = {
        stream: !0
...
"[project]/UAS_SOSIALMEDIA/client-new/node_modules/next/dist/compiled/react-server-dom-turbopack/client.browser.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
;
    ...
    module.exports = __turbopack_context__.r("[project]/UAS_SOSIALMEDIA/client-new/node_modules/next/dist/compiled/react-server-dom-turbopack/cjs/react-server-dom-turbopack-client.browser.development.js [app-client] (ecmascript)");
}
}),
"[project]/UAS_SOSIALMEDIA/client-new/node_modules/next/dist/compiled/react-server-dom-turbopack/client.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

module.exports = __turbopack_context__.r("[project]/UAS_SOSIALMEDIA/client-new/node_modules/next/dist/compiled/react-server-dom-turbopack/client.browser.js [app-client] (ecmascript)");
}),
]);

//# sourceMappingURL=196c1_next_dist_compiled_react-server-dom-turbopack_bdad6233._.js.map